...
apply_branding(
    BrandingConfig(
        app_title="Bayesian Weibull Dissolution Modeling",
        header_title="Dissolution Profiles — Bayesian Weibull",
        header_subtitle="PyMC-based Weibull fit and comparison",
    )
)
